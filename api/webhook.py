...
# Initialize the bot
BOT_TOKEN = os.environ.get('BOT_TOKEN')  # Correct the environment variable name
bot = AsyncTeleBot(BOT_TOKEN)

# Firebase
firebase_config = json.loads(os.environ.get('FIREBASE_SERVICE_ACCOUNT'))  # Correct environment variable
